...
const PaymentForm = ({ onSubmit, loading }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (selectedFarmer && parseFloat(formData.amount) > selectedFarmer.dueAmount) {
            ...
            {selectedFarmer && (
              <div className="p-6 rounded-2xl bg-green-50 border border-green-100">
                ...
                <div className="flex items-baseline gap-2">
                  <span className="text-3xl font-black text-green-800">₹{selectedFarmer.dueAmount.toLocaleString()}</span>
                  <span className="text-green-600 text-sm font-medium">pending due</span>
                </div>
                {selectedFarmer.dueAmount === 0 && (
